...
import tw.dev.tomoaki.excel.core.IExcelCreator;
import tw.dev.tomoaki.excel.entity.ExcelTable;
import tw.dev.tomoaki.excel.exception.ExcelCreatorException;

/**
 *
 * @author Tomoaki Chen
 */
public class JXLExcelCreator implements IExcelCreator {
    ...
    public JXLExcelCreator(String filePath) throws IOException, BiffException {
        /*
    ...
    public void writeTable(ExcelTable dataTable, String sheetName) {
        try {
            ...
            throw new ExcelCreatorException(ex);
        }
    }
