 ...
 */
package tw.dev.tomoaki.datetimecloze.entity.time;

import tw.dev.tomoaki.datetimecloze.entity.date.*;
 ...
 * @author tomoaki
 */
public final class TimeCloze {

    private String format;

    private ClozeHourPart hourPart;
    private ClozeMinutePart minutePart;
    private ClozeSecondPart secondPart;

    protected TimeCloze() {
    }


    public static TimeCloze create(String format) {
        TimeCloze cloze = new TimeCloze();
        cloze.format = format;
        cloze.doSetupParts();
        return cloze;
    }
    ...
    protected void doSetupParts() {
        ...
        hourPart = ClozeFormatHelper.analyzeHourPart(format);
        minutePart = ClozeFormatHelper.analyzeMinutePart(format);
        secondPart = ClozeFormatHelper.analyzeSecondPart(format);
    }
    ...
    public ClozeHourPart getHourPart() {
        return hourPart;
    }

    public ClozeMinutePart getMinutePart() {
        return minutePart;
    }

    public ClozeSecondPart getSecondPart() {
        return secondPart;
    }
