...
import tw.dev.tomoaki.datetimecloze.entity.time.ClozeHourPart;
import tw.dev.tomoaki.datetimecloze.entity.time.ClozeMinutePart;
import tw.dev.tomoaki.datetimecloze.entity.time.ClozeSecondPart;
...
//<editor-fold defaultstate="collapsed" desc="這裡是對 Cloze Format 進行分析">
     ...
     * @return 「小時」的克漏字題
     */
    public static ClozeHourPart analyzeHourPart(String clozeFormat) {
        ClozeHourPart hourPart = new ClozeHourPart();
     ...
     * @return 「分鐘」的克漏字題
     */
    public static ClozeMinutePart analyzeMinutePart(String clozeFormat) {
        ClozeMinutePart minutePart = new ClozeMinutePart();
     ...
     * @return 「秒」的克漏字題
     */
    public static ClozeSecondPart analyzeSecondPart(String clozeFormat) {
        ClozeSecondPart secondPart = new ClozeSecondPart();
